...
var bronzeGoat = {
	...
	description: "Increases money production by <span id=\"bronzeGoatModDescription\">0.0</span> per/s for each bronze goat.",
...
var silverGoat = {
	...
	description: "Increases money production by <span id=\"silverGoatModDescription\">0.0</span> per/s for each silver goat.",
...
var goldGoat = {
	...
	description: "Increases money production by <span id=\"goldGoatModDescription\">0.0</span> per/s for each gold goat.",
...
var goatHero = {
	...
	description: "Allows you to venture on amazing goat quest. More goat heroes increase completion speed.",
	...
	show: false,
	costId: "goatHeroCost",
	getCost: function() { return Math.floor(200 * (getPurchase(goatHero).count + 1)); },
	cost: "<span id=\"goatHeroCost\">0</span> money",
	count: 0
}
...
var scienceGoat = {
	...
	description: "Increases electricity generation by <span id=\"scienceGoatModDescription\">0.0</span> for each science goat.",
